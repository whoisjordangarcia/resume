const resumeContent = {
    ...
    profileContent: "A passionate Engineering Manager with 15+ years of experience in developing robust web applications and backend services. Demonstrates strong leadership in managing small to medium teams, delivering project milestones, and developing strategic roadmaps. Adept in fostering team growth, encouraging cross-functional collaboration, and mentoring. Versatile in technology, proficient in switching in-between individual contributor and management roles, ensuring high-quality software solutions.",
    jobs: [
        {
            ...
            hightlights: [
                ...
                "Managed a diverse team comprising from junior to seniors  individual contributors and contractors, maintaining high productivity and engagement.",
                "Instituted CI/CD practices and overall system availability significantly from 80.123% to 99.9984%."
            ]
        },
        {
