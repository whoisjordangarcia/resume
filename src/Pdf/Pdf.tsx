...
const Pdf = () => (
  ...
  >
    <Page debug={false} style={styles.body}>
      <Text style={styles.name}>test Jordan Garcia</Text>
      <Text style={styles.jobTitle}>Engddineering Manager</Text>
      ...
      <Text style={styles.text}>Programming Languages: Typescript, Python</Text>
      <Text style={styles.text}>Frameworks: React, Django, NextJs, NestJs</Text>
      <Text style={styles.text}>
        Tools & Technologies: Auth0, Kubernetes, Kafka, Contentful, NewRelic,
      ...
      <Text style={styles.text}>
        - Led the identity team, migrating 4.5 million user accounts to a modern
        authentication system with zero downtime. - Spearheaded the development
        of an authorization system enhancing resource access auditing. - Managed
        a diverse team comprising seniors individual contributors and
        contractors, maintaining high productivity and engagement. - Instituted
        CI/CD practices, significantly reducing P1 incidents and improve system
        availability from 80.123% to 99.9984%.
      </Text>

      <Text style={styles.subtitle}>Engineering Lead, Invitae, Remote</Text>
      <Text style={styles.subtitle}>Nov 2018 - May 2021</Text>
      <Text style={styles.text}>
        - Created the preview deploy system at the company, enabling designers
        and product to test new web functionality before merging to the main
        branch. - Directed and migrated invitae.com website from legacy django
        cms to contentful building a re-useable CMS UI library. Allowing
        marketing to deploy new pages on demand vs weekly/monthly releases. -
        Led the decentralization of the largest monolithic application into
        microservices, elevating system reliability, maintainability, and
        resilience on company re-orgs.
      </Text>

      <Text style={styles.subtitle}>
        Senior Software Engineer, TodayTix, New York, NY
      </Text>
      <Text style={styles.subtitle}>Oct 2017 - Oct 2018</Text>
      <Text style={styles.text}>
        - Launched a high-impact broadway show lottery feature, boosting site
        traffic by 20%. - Migrated the web application to typescript, enhacning
        code reliability and maintainability.
      </Text>

      <Text style={styles.subtitle}>
        Senior Software Engineer, Tigerspike, New York, NY
      </Text>
      <Text style={styles.subtitle}>Feb 2014 - Oct 2017</Text>
      <Text style={styles.text}>
        - Redesigned a global intranet for a leading financial firm, integrating
        efficient search capbilities. - Developed a geographically aware asset
        management website, supporting over 30 countries with optimal
        performance.
      </Text>

      <Text style={styles.title}>Education</Text>
      <Text style={styles.text}>Bachelor of Computer Science</Text>
      <Text style={styles.text}>
