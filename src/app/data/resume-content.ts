const resumeContent = {
  ...
  education: {
    ...
    achievements: [
      ...
      "Finalist Nomination of APICTA Awards",
      "Winner of 21st WAiTTA Tertiary Student Award",
    ],
  },
  skills: [
    "Python",
  ...
  skillsAndInterest: {
    programmingLanguages: ["Javascript", "Python", "Typescript", "C#"],
    frameworks: [
      "React",
      "Django",
      "Next.js",
    ...
    cloudServices: [
      "New Relic, Github Actions, AWS (S3, Cloudfront, Cloudwatch, S3, SES, SNS, SQS, ECS, DynamoDB), Auth0",
    ],
